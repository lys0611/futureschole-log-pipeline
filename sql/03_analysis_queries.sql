...
SELECT
  ...
  avg_request_time
FROM `PROJECT_ID.BIGQUERY_DATASET.vw_endpoint_error_rate`
...
FROM `PROJECT_ID.BIGQUERY_DATASET.vw_cart_event_summary`
...
FROM `PROJECT_ID.BIGQUERY_DATASET.vw_product_interest_cart_summary`
