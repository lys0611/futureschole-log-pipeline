...
curl --output /dev/null --silent --head --fail "https://github.com/lys0611/futureschole-log-pipeline/raw/refs/heads/main/day1/Lab01/traffic_generator/tg_full_setup.sh" || { echo "kakaocloud: Script download site is not valid"; exit 1; }

wget https://github.com/lys0611/futureschole-log-pipeline/raw/refs/heads/main/day1/Lab01/traffic_generator/tg_full_setup.sh
